...
<div class="container-fluid">
    ...
    <div>
        ...
        <div class="container">
            <form method="post" action="/opretbrugeraction.php">
                <fieldset>
                <div>
                    <p>Beløb</p>
                    <select class="btn btn-light dropdown-toggle" id="dropdownbeloeb" data-toggle="dropdown" name="beloeb">
            ...
            ?>
                ...
                <div>
                    <p>Rente</p>
                    <select class="btn btn-light dropdown-toggle" id="dropdownrente" data-toggle="dropdown" name="rente">
            ...
            ?>
                ...
                <div>
                    <p>Løbetid</p>
                    <select class="btn btn-light dropdown-toggle" id="dropdownloebetid" data-toggle="dropdown" name="loebetid">
            ...
            ?>
                ...
                <div>
                    ...
                    <select class="btn btn-light dropdown-toggle" id="dropdownkontraktbrud" data-toggle="dropdown" name="kontraktbrud">
            ...
            ?>
                ...
                <input type="email" id="laantageremail" name="mail" placeholder="låntager@mail.dk">
                <?php
                if(isset($_POST['mail'])) {
                    $mail = $_POST['mail'];
            ...
            ?>
                ...
                <p><I>"Gem låneaftale" - Kontrakten gemmes under Min profil - <strong>Mine aftaler</strong> hvor den skal underskrives</I></p>
                    ...
                    <button name = "submit" type="submit" class="btn btn-light">Underskriv og gem</button>
                </fieldset>
            </form>
            <br>
        </div>
...
$(document).ready(function(){
    $form.submit(function(event){
        ...
        var beloeb = $("#dropdownbeloeb").val();
        var rente = $("#dropdownrente").val();
        var loebetid = $("#dropdownloebetid").val();
        var kontraktbrud = $("#dropdownkontraktbrud").val();
        var laantagermail = $("#laantageremail").val();
        $(.form-message).load("opretkontraktaction.php",{
            beloeb: beloeb,
            rente: rente,
            loebetid: loebetid,
            laantageremail: laantageremail
        })
    })
})
</script>
